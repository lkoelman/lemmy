...
type NavbarState = typeof emptyState
...
export class Navbar extends Component<any, NavbarState> {
  ...
  // Define state property to make it modifiable (@types/react ^16.4.2)
  state: NavbarState;
  ...
  navbar() {
    return (
      <nav className="container-fluid navbar navbar-expand-md navbar-light shadow p-0 px-3">
        ...
        >
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item">
              <Link className="nav-link" to="/search" title={i18n.t('search')}>
                {i18n.t('search')}
              </Link>
            </li>
            <li className="nav-item">
          ...
          <ul className="navbar-nav ml-auto">
            ...
            {this.state.isLoggedIn ? (
              <>
                <li className="nav-item mt-1">
                  <Link className="nav-link" to="/inbox" title={i18n.t('inbox')}>
                    <svg className="icon">
                      <use xlinkHref="#icon-bell"></use>
                    </svg>
                    {this.state.unreadCount > 0 && (
