export const ca = {
  translation: {
    ...
    delete_account_confirm: "Avís: aquesta acció eliminarà permanentment la teva informació. Introdueix la teva contrasenya per a continuar",
    restore: "restaurar",
    ban: "expulsar",
    ...
    notifications_error: "Notificacions d'escriptori no disponibles al teu navegador. Prova amb Firefox o Chrome.",
    ...
    private_message_disclaimer: "Avís: Els missatges privats en Lemmy no són segurs. Sisplau creu un compte en <1>Riot.im</1> per a mensajeria segura.",
    ...
    sponsor_message: "Lemmy és programari lliure i de <1>codi obert</1>, la qual cosa significa que no tindrà publicitats, monetització, ni capitals emprenedors, mai. Les teves donacions secunden directament el desenvolupament a temps complet del projecte. Moltes gràcies a les següents persones:",
    ...
    couldnt_find_that_username_or_email: "No s'ha pogut trobar aquest nom de usuari o correu electrònic.",
