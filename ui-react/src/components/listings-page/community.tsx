...
/**
 * Page showing post listings in a specific community.
 */
export class Community extends Component<any, ICommunityState> {
  private subscription: Subscription;
  private emptyState: ICommunityState = {
    community: {
      id: null,
      name: null,
      title: null,
